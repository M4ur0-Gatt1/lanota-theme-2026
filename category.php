...
<div class="container">
    ...
    <main class="main-content">
        <div class="header">
            ...
            <?php if (category_description()) : ?>
                <p style="color: var(--text-secondary); margin-top: 5px;"><?php echo category_description(); ?></p>
            <?php endif; ?>
        </div>
            ...
            <?php else : ?>
                <div class="no-posts">
                    <div class="post" style="text-align: center; padding: 40px;">
                        ...
                        <p>Aún no se han publicado artículos en la categoría "<?php single_cat_title(); ?>".</p>
    ...
    <aside class="right-sidebar">
        ...
        <div class="widget">
            <div class="widget-header">Otras Categorías</div>
        ...
        <div class="widget">
            ...
            <div class="widget-content">
                ...
                $recent_posts = new WP_Query(array(
                    'posts_per_page' => 5,
                    'category__not_in' => array($current_category->term_id)
                ));
